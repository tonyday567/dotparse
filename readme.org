...
** Next reproduction of svg that dot creates
...
digraph {
	...
	RealFloat	[pos="72,18",
		width=0.95833];
	RealFrac -> RealFloat	[pos="e,82.018,36.104 102.87,71.697 97.553,62.626 90.98,51.404 85.267,41.65"];
	Real	[pos="117,162",
		width=0.75];
	Real -> RealFrac	[pos="e,113.98,108.1 116.01,143.7 115.51,134.88 114.89,124.03 114.34,114.47"];
	Integral	[pos="193,90",
		width=0.81944];
	Real -> Integral	[pos="e,174.17,108.35 135.79,143.7 146.02,134.27 158.77,122.53 169.64,112.52"];
	Ord2	[pos="268,90",
		width=0.75];
	Ord1	[pos="266,162",
		width=0.75];
	Ord1 -> Ord2	[pos="e,267.51,108.1 266.49,143.7 266.75,134.88 267.06,124.03 267.33,114.47"];
	Ord	[pos="302,234",
		width=0.75];
	Ord -> Real	[pos="e,144.47,174.89 274.58,223.45 245.31,213.15 197.63,196.05 157,180 154.84,179.15 152.62,178.25 150.38,177.34"];
	Ord -> Ord1	[pos="e,274.8,180.1 293.1,215.7 288.44,206.63 282.67,195.4 277.65,185.65"];
	Ix	[pos="338,162",
		width=0.75];
	Ord -> Ix	[pos="e,329.2,180.1 310.9,215.7 315.56,206.63 321.33,195.4 326.35,185.65"];
	Num	[pos="77,234",
		width=0.75];
	Num -> Real	[pos="e,107.23,180.1 86.888,215.7 92.071,206.63 98.483,195.4 104.06,185.65"];
	Fractional	[pos="36,162",
		width=0.98611];
	Num -> Fractional	[pos="e,46.018,180.1 66.865,215.7 61.553,206.63 54.98,195.4 49.267,185.65"];
	Floating	[pos="31,90",
		width=0.86111];
	Fractional -> Floating	[pos="e,32.222,108.1 34.764,143.7 34.134,134.88 33.359,124.03 32.677,114.47"];
	Floating -> RealFloat	[pos="e,61.982,36.104 41.135,71.697 46.447,62.626 53.02,51.404 58.733,41.65"];
	...
	Eq1	[pos="410,234",
		width=0.75];
	Eq1 -> Eq2	[pos="e,410,180.1 410,215.7 410,206.88 410,196.03 410,186.47"];
	Eq	[pos="410,306",
		width=0.75];
	Eq -> Ord	[pos="e,328.63,252.26 383.03,287.52 368.09,277.84 349.45,265.75 333.81,255.62"];
	Eq -> Eq1	[pos="e,410,252.1 410,287.7 410,278.88 410,268.03 410,258.47"];
	Bits	[pos="486,234",
		width=0.75];
	Eq -> Bits	[pos="e,467.17,252.35 428.79,287.7 439.02,278.27 451.77,266.53 462.64,256.52"];
	Enum	[pos="193,162",
		width=0.75];
	Enum -> Integral	[pos="e,193,108.1 193,143.7 193,134.88 193,124.03 193,114.47"];
	Bits -> FiniteBits	[pos="e,489.02,180.1 486.99,215.7 487.49,206.88 488.11,196.03 488.66,186.47"];
}
#+end_example
...
digraph {
    ...
    graph [bb="0,0,525,324";center=true;overlap=false;rankdir=TB;size="5!";splines=spline]
    edge [arrowsize=0.5]
