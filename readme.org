...
[[https://sketchviz.com/new][Sketchviz - Create and publish Graphviz graphs on the web for free]]

[[https://medium.com/@zeruhur/making-sketchy-diagrams-on-your-local-machine-903d13e20a13#id_token=eyJhbGciOiJSUzI1NiIsImtpZCI6IjliMDI4NWMzMWJmZDhiMDQwZTAzMTU3YjE5YzRlOTYwYmRjMTBjNmYiLCJ0eXAiOiJKV1QifQ..sJtrYarRihx2EF9HENxsuM9Ith3RChTjHqRAumQ7TTZqZ-iL50BXQ4QmEbHp-lAPV8MOjAQmcTJQ4NcEqfiOIcljSYD8RBw0zLmL3HNnKV3PNkPJQ1e4lFgaVSWx3mHat1Hj9FZ1L3xH5B96Ln4_Y9anXmGnjFvcJIPQJyBBu-w85mhk3AuEGUIa5kR-H8FNXz-Mjqu7wxjrY_RPazwklm6q6J9n5EXz6wXFUEG6Bz0hbRTt4im6WUP_peLBrWxwvqmIY1e-FIvGNJxBLCkWpa4F-utjXxYlT35fh2dKp23v5y300sUtKDB9zbLESAwlDcfea3bVKAS6a7gRENHgQA][Making “sketchy” diagrams on your local machine | by Roberto Bisceglie | Medium]]

[[https://github.com/gpotter2/sketchviz][GitHub - gpotter2/sketchviz: A command line clone of https://sketchviz.com/]]
...
#+begin_src haskell-ng :results output
display $ (graphToChartWith (defaultChartConfig & #labelf .~ (Text.pack . show) & #chartColor .~ over lightness' (* 0.5) (palette 2) & #chartBackgroundColor .~ set opac' 0.0 (palette 1)) (dotGraphAST Directed))
#+end_src
...
#+begin_src haskell-ng :results output
pPrint $ dotPrint defaultDotConfig $ dotGraphAST Directed
#+end_src
...
#+begin_src haskell-ng :results output
:t defaultGraph & #directed .~ Last (Just Directed) & addStatements (toStatements Directed (FP.strToUtf8 <$> (G.edges ((\c -> (view #super c, view #name c)) <$> components) <> G.vertices (view #name <$> components)))) & attL NodeType (ID "shape") .~ Just (ID "box") & gattL (ID "rankdir") .~ Just (IDQuoted "TB")
#+end_src

  #+RESULTS:
  : defaultGraph & #directed .~ Last (Just Directed) & addStatements (toStatements Directed (FP.strToUtf8 <$> (G.edges ((\c -> (view #super c, view #name c)) <$> components) <> G.vertices (view #name <$> components)))) & attL NodeType (ID "shape") .~ Just (ID "box") & gattL (ID "rankdir") .~ Just (IDQuoted "TB")
  :   :: Graph
